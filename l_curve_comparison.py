...
X_lcurve_1, R_lcurve_1= hybrid_AB_GMRES(A,B,b,iter,ct.m, ct.n, ct.num_angles, p = p, regparam= 'lcurve_1', delta = delta)
...
plt.savefig('test_images/l_curve_comparison'+ name+'_'+str(ct.num_pixels) + '_p'+str(p)+'_'+str(ct.num_angles)+'ang.jpg', format="jpg", bbox_inches="tight")
